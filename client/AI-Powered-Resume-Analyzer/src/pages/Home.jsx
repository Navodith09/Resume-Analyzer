...
const Home = () => {
    ...
    return (
        <div className="pb-20 bg-gray-50 dark:bg-gray-900 min-h-screen transition-colors duration-200">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 text-center">
                <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight text-gray-900 dark:text-white mb-4">
                    ...
                    <span className="block text-indigo-600 dark:text-indigo-400">ATS Success</span>
                </h1>
